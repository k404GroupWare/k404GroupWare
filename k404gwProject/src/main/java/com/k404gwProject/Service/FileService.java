...
public class FileService {
    ...
    public static String getRootPath(String fileName, HttpServletRequest request) {
        ...
        MediaType mediaType = MediaUtils.getMediaType(fileName); // 파일타입 확인
//        String fileTest = rootPath + "/" + fileName;
//        System.out.println("fileTest" + fileTest);
        System.out.println("request.getSession().getServletContext().getRealPath(rootPath)" + request.getSession().getServletContext().getRealPath(rootPath));
        if (mediaType != null)
//        	return rootPath;
